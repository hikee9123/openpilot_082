...
FEATURES = {
  ...
  "use_elect_gears": set([CAR.GRANDEUR_HEV_19,CAR.KIA_NIRO_EV, CAR.KIA_OPTIMA_H, CAR.IONIQ_EV_LTD, CAR.KONA_EV, CAR.IONIQ, CAR.IONIQ_EV_2020]),
  ...
  "use_bsm": set([CAR.GRANDEUR_HEV_19,CAR.SONATA, CAR.PALISADE, CAR.HYUNDAI_GENESIS, CAR.GENESIS_G70,
                  CAR.GENESIS_G80, CAR.GENESIS_G90, CAR.KONA, CAR.IONIQ_EV_2020,
                  CAR.SANTA_FE, CAR.KIA_NIRO_EV]),

  # send LFA MFA message for new HKG models
  "use_lfa_mfa": set([ CAR.GRANDEUR_HEV_19, CAR.PALISADE ]),                  
}
